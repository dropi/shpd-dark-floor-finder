...
public class DungeonSeed {
	...
	// generates a random seed, omitting seeds that contain vowels (to minimize real
	// words appearing randomly)
	// This means that there are 21^9 = 794,280,046,581 unique seeds that can be
	// randomly generated
	...
	public static long convertFromText(String inputText) {
		...
		// Then see if input is a number (ignoring spaces), if so parse as a long seed
		// (with overflow)
		try {
		...
		// Finally, if the user has entered unformatted text, convert it to a long seed
		// equivalent
